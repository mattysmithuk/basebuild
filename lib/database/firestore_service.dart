...
class FirestoreService {
  ...
  Future<List<T>> collectionFilteredGet<T>(
      {required String path,
      required T builder(Map<String, dynamic> data, String documentID),
  ...
  Future<List<T>> collectionFilteredArrayGet<T>(
      {required String path,
      required T builder(Map<String, dynamic> data, String documentID),
      required String filterKey,
      required dynamic filterValue,
  ...
  Stream<List<T>> collectionOrderedStream<T>(
      {required String path,
      required orderBy,
      required T builder(Map<String, dynamic> data, String documentID),
      Query queryBuilder(Query query)?,
  ...
  Stream<List<T>> collectionFilteredOrderedStream<T>(
      {required String path,
      required orderBy,
      required String filterKey,
      required dynamic filterValue,
